...
*"🔒 Audit complete. Report saved. Here's your launch status: [overall status]. [If cleared: Your app is hardened and ready to ship. Nice work.] [If conditional: Review the open items before going public.] [If not cleared: Resolve the High priority items first — I can walk you through any of them.]"*
